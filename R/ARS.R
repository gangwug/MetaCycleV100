...
### Author of R script of ARSER: Gang Wu
...
###-----------------------------------------------------------------------------
LL<-function(e,nobs,ncoef)                                 #calculate model log-likelihood and two information criteria(AIC and BIC criterion values)                               
{
...
###-----------------------------------------------------------------------------
OLS<-function(x, y, x_varnm='', y_varnm ='y')              #multi-variate regression using OLS
{
...
{
  ## estimate possiable cycling period of time series by AR spectral estimation
